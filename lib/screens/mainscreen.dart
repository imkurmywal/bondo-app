    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          recording==true ? Align(
            alignment: Alignment.bottomCenter,
            child:_recordingPart()
          ):SizedBox(),
        ],
      ),
  ...
  Widget _recordingPart(){
    return Container(
      ...
      child: Column(
        children: [
          SizedBox(height: 10,),
          Text('Voice Recording...',style: TextStyle(fontWeight: FontWeight.bold),)
          ,Column(
            mainAxisAlignment: MainAxisAlignment.start,
            children: [
              Padding(
                  padding:EdgeInsets.only(top: 10,right: SizeConfig.blockSizeHorizontal*25),
                  child: Text('Timer',style: TextStyle(fontSize: 13,color: Colors.grey),))
              ,Container(
                  ...
                  children: [
                    ...
                    send==false?GestureDetector(
                      ...
                      child: CircleAvatar(
                          ...
                          child: Image.asset('assets/images/send.png',scale: 5,)),
                    ),
